...
# News
* Mar 2025: Our paper on [sliced-Wasserstein-based image alignment](https://arxiv.org/pdf/2503.13756v1) is posted online. It is the first OT-based alignment method that achieves $O(L^2\log L)$ complexity for $L\times L$ images, which matches that of the Euclidean-based methods. Code is available [here](https://github.com/EricVerbeke/fast_image_alignment_ot).
